        ...
        <Card className="border-red-200 bg-red-50">
          ...
          <CardContent>
            <div className="space-y-4">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1 mt-1">
                  {critiques.technical.map((critique, index) => (
                    <li key={`tech-${index}`} className="text-red-700">{critique}</li>
                  ))}
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1 mt-1">
                  {critiques.market.map((critique, index) => (
                    <li key={`market-${index}`} className="text-red-700">{critique}</li>
                  ))}
                </ul>
              </div>
              ...
              <div>
                <h3 className="font-semibold flex items-center gap-1 text-red-800">
                  <LightbulbIcon className="h-4 w-4" /> Originality
                </h3>
                <ul className="list-disc pl-5 space-y-1 mt-1">
                  {critiques.originality.map((critique, index) => (
                    <li key={`orig-${index}`} className="text-red-700">{critique}</li>
                  ))}
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1 mt-1">
                  {critiques.consequences.map((critique, index) => (
                    <li key={`conseq-${index}`} className="text-red-700">{critique}</li>
                  ))}
                </ul>
              </div>
            </div>
