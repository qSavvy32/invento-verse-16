...
interface InventionRepositoryProps {
...
export const InventionRepository = ({ 
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Assets Repository Section */}
      {!hideAssets && (
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Assets Repository</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                {!state.sketchDataUrl && 
                 ...
                 state.assets.length === 0 && (
                  <div className="text-sm text-muted-foreground italic">
                    No assets uploaded yet. Use the tools above to add sketches and visualizations.
                  </div>
                )}
              </div>
            </div>
