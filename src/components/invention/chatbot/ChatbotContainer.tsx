  ...
  return (
    <div className="mt-6">
      <Tabs defaultValue="chat" value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="voice" className="border rounded-lg flex justify-center items-center">
          {/* Only render the voice conversation component when the voice tab is active */}
          {activeTab === "voice" && (
            <div id="elevenlabs-widget-direct-mount" className="w-full flex justify-center p-0">
              <VoiceConversation 
